...
**On Ubuntu 20.04 FF, 22.04 JJ or 24.04 NN only :**
        ...
        wget -O BeLGE_Install.sh https://github.com/rdh59320/BeLGE/releases/download/BeLGE-V2-0/BeLGE-Ubuntu-V2-0.sh && sudo chmod +x BeLGE_Install.sh && sudo bash BeLGE_Install.sh
